      ...
      z
        .object({
          ...
          fullName: z
            ...
            .min(
              MIN_LENGTH_FULLNAME,
              t('validation.auth.min_name_length', { p: MIN_LENGTH_FULLNAME }),
            ),
          password: z
            .string(t('validation.required'))
            .nonempty(t('validation.required'))
            ...
            .min(
              MIN_LENGH_PASSWORD,
              t('validation.auth.min_password_length', { p: MIN_LENGH_PASSWORD }),
            ),
          confirmPassword: z.string(t('validation.required')).nonempty(t('validation.required')),
        })
