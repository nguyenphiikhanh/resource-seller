          ...
          <Table>
            <TableHeader class="bg-primary/5 dark:bg-slate-900 border-b">
              <TableRow>
                ...
                <TableHead class="text-center">Ghi (Write)</TableHead>
                <TableHead class="text-center">Xóa (Delete)</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              <TableRow v-for="p in permissions" :key="p.module" class="border-b last:border-0">
                <TableCell class="font-bold text-sm text-slate-800 dark:text-slate-100">{{ p.module }}</TableCell>
